...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.1"
  spec.summary      = "A short description of HPFloatMenu."
  ...
  spec.description  = "A library for floating menu"
  ...
  spec.source       = { :git => "https://github.com/quanghoang0101/HPFloatMenu.git", :tag => "0.0.1" }
